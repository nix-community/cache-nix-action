...
export const cache: typeof actionsCache | typeof buildjetCache | typeof warpbuildCache =
    backend == Backend.Actions
        ? actionsCache
        : backend == Backend.WarpBuild
          ? warpbuildCache
          : buildjetCache;
export const cacheUtils: typeof actionsCacheUtils | typeof buildjetCacheUtils | typeof warpbuildCacheUtils =
    backend == Backend.Actions
        ? actionsCacheUtils
        : backend == Backend.WarpBuild
          ? warpbuildCacheUtils
